...
//			size_t flag;
//			void* ud;
//			std::vector<std::pair<int, int>> cellMappings;
//		};
//
//		struct Mapping {
//			int item;
...
//
//	public:
//		Grid(Size const& cellSize, int const& rowCount, int const& columnCount, int const& itemCap, int const& cellCap) {
...
//
//			itemBuf.resize(itemCap);
//			itemBufCap = itemCap;
//
//			mappingBuf = (Mapping*)malloc(sizeof(Mapping) * itemCap * cellCap);
//			mappingBufCap = itemCap * cellCap;
//
//			Clear();
//		}
//
...
//			assert(((siz.w - 1) / cellSize.w + 1) * ((siz.h - 1) / cellSize.h + 1) <= cellCap);
//
//			int idx;
//			if (freeItemCount) {
//				idx = freeItemHeader;
...
//					o.cellMappings.push_back({ cIdx, MappingAdd(cIdx, idx) });
//				}
//			}
//		}
//
//		void ItemClearMappings(Item& o) {
//			for (auto& m : o.cellMappings) {
//				MappingRemoveAt(m.first, m.second);
//			}
//			o.cellMappings.clear();
//		}
//
